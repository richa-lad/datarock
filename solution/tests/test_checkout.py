...
def test_scan_raises_item_not_in_catalogue(pricing_rules: PricingRule, catalogue: Dict[str, Item]):
    co = Checkout(
        pricing_rules=pricing_rules,
        catalogue=catalogue
    )
...
def test_scan_raises_error_bad_attribute(pricing_rules: PricingRule, catalogue: Dict[str, Item]):
    co = Checkout(
        pricing_rules=pricing_rules,
        catalogue=catalogue
    )
